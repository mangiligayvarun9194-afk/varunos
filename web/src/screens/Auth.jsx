...
export default function Auth({ onAuthed }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'var(--bg)', display: 'flex',
      ...
      <img aria-hidden src="/img/sarathi-master.webp" alt="" style={{ position: 'fixed', right: '-6%', bottom: '-4%', height: '92%', zIndex: 0,
        opacity: 0.16, pointerEvents: 'none', WebkitMaskImage: 'radial-gradient(70% 80% at 60% 45%, #000 40%, transparent 80%)', maskImage: 'radial-gradient(70% 80% at 60% 45%, #000 40%, transparent 80%)' }} />
